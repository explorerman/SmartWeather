...
import com.lijie.smartweather.beans.HttpCallbackListener;
...
//        if (!ServletUtil.isNetworkAvailable()){
//            //这里写相应的网络设置处理
//            return;
//        }
        if(!Utility.isNetworkConnected(BaseApplication.getAppContext())){
            Toast.makeText(BaseApplication.getAppContext(),"请求失败,请检查网络状况",Toast.LENGTH_SHORT).show();
        }
