package com.lijie.smartweather.service;
...
public class AutoUpdateService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Logger.d("AutoUpdateService服务启动了");
    ...
    private void updateWeather(){
        ...
        if (weatherString != null) {
            ...
            String weatherUrl = "https://free-api.heweather.com/v5/weather?city=" + city + "&key=f24d4c2e4088430080ba89d9c5ed5f7a";
